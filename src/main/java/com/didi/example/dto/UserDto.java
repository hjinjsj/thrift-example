...
public class UserDto implements org.apache.thrift.TBase<UserDto, UserDto._Fields>, java.io.Serializable, Cloneable, Comparable<UserDto> {
  ...
  public UserDto setName(@org.apache.thrift.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UserDto setMobile(@org.apache.thrift.annotation.Nullable String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIsDeleted()) ? 131071 : 524287);
    if (isSetIsDeleted())
      hashCode = hashCode * 8191 + ((isDeleted) ? 131071 : 524287);
